...
<<example-parameter-design, results>>=
...
design_xtable <- xtable(cbind(Parameters = design_desc, design_table),
                        align = "lRrr")
@
...
\begin{table}[H]
  ...
  \centering
    <<parameter-design-table, results = "asis">>=
  print(design_xtable,
...
<<pred-plot-1, fig.height = 4, fig.cap = "Model comparison based on prediction error for each response.", fig.width = "\\textwidth", fig.pos = "H">>=
getPredPlot(1, ymin = 0.3, ymax = 1.2)
@



<<pred-plot-2, fig.height = 4, fig.cap = "Train and test prediction error for different response comparing models under comparison", fig.width = "\\textwidth", fig.pos = "H">>=
getPredPlot(2)
@