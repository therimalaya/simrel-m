...
\begin{figure}[H]
\includegraphics[width=1\linewidth]{main_files/figure-latex/rmsep-plot-1} \caption{Root mean square of error of prediction of test observation.}\label{fig:rmsep-plot}
\end{figure}
