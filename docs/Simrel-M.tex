...
\begin{figure}
\includegraphics[width=1\linewidth]{Simrel-M_files/figure-latex/cov-plot-print-1} \caption{Simulation of predictor and response variables after orthogonal transformation of principal components by a rotation matrix}\label{fig:cov-plot-print}
\end{figure}
...
\emph{Senv}\strut
\end{minipage} & \begin{minipage}[t]{0.19\columnwidth}\centering\strut
\textbf{\emph{(4, 1.63)}}\strut
\end{minipage} & \begin{minipage}[t]{0.19\columnwidth}\centering\strut
\textbf{\emph{(5, 1.62)}}\strut
\end{minipage} & \begin{minipage}[t]{0.19\columnwidth}\centering\strut
(3, 1.99)\strut
\end{minipage} & \begin{minipage}[t]{0.19\columnwidth}\centering\strut
(5, 1.96)\strut
